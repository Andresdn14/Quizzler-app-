...
//  Quizzler
//
//  Created by Andres Felipe De La Ossa Navarro on 10/27/18.
...
class QuestionBank {
    ...
    init() {
        ...
        let item = Question(text: "The iphone XS was released in 2018", correctAnswer: true)
        
        // Add the Question to the list of questions
        list.append(item)
        
        // skipping one step and just creating the quiz item inside the append function
        list.append(Question(text: "The iphone XS was released in 2018", correctAnswer: true))
